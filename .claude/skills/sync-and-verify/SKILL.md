...
3. **Verify via Composio** — Use `COMPOSIO_SEARCH_TOOLS` to find `SUPABASE_BETA_RUN_SQL_QUERY`, then execute:
...
4. **Report results** — Show table counts and latest sync run status
